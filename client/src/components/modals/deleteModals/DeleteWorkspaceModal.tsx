...
const DeleteWorkspaceModal = () => {
  ...
  const { deleteworkspacemodal } = useSelector(
    (store: { modal: { deleteworkspacemodal: boolean } }) => store.modal
  );
        ...
        <div className="w-full flex px-8 items-center justify-between gap-1">
          <h3 className="text-2xl md:text-2xl ">
            ...
            <span className="text-sm block text-[#777] max-w-[600px] md:text-sm">
              You have to cautious with this action because it cannot be
              reversed. Are you sure you want to delete this workspace? This
              cannot be undone!
            </span>
          </h3>
