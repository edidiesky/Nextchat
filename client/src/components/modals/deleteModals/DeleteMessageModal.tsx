...
const DeleteMessageModal = () => {
  ...
  const { deletemessagemodal } = useSelector(
    (store: { modal: { deletemessagemodal: boolean } }) => store.modal
  );
            ...
            <div className="w-full border rounded-lg p-4 flex items-center gap-4">
              ...
              <div className="flex-1 flex items-start flex-col justify-start gap-1">
                <div className="flex w-full items-center gap-2">
                  <span className="text-base md:text-base family2 text-dark">
                    {data?.sender?.name}
                  </span>
                ...
                <div className="flex-1 flex flex-col gap-1">
                  <span className="w-full md:max-w-[500px] text-sm md:text-sm leading-[1] text-dark">
                    {data?.text}
                  </span>
                  {data?.img && (
                    <div className="h-[280px] relative w-[250px] md:w-[450px]">
                      <img
