      ...
      <div className="w-full p-4 border-[#e7e7e736] lg:border min-h-[55px] rounded-xl max-w-custom mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center justify-end gap-8 md:gap-12">
          <div className="hidden lg:flex flex-1 justify-center items-center gap-12">
            <Link to={"#"} className="text-base text-white font-normal">
              Features
            </Link>
            <Link to={"#"} className="text-base text-white font-normal">
              App
              ...
              <div className="flex items-center justify-end gap-2 md:gap-4">
                <span className="">
                  <button
                    ...
                    className="text-xs lg:text-sm px-4 lg:px-4 py-2 border-[#e7e7e736] border rounded-full text-dark bg-[#fff]"
                  >
                    Join with Us
                  </button>
                </span>
                <button
                  ...
                  className="text-xs lg:text-sm text-white px-4 lg:px-4 py-2 rounded-full border-[#e7e7e736] border"
                >
                  Get Started
                </button>
              </div>
